...
function Episode() {
  ...
  //I need to find out how many episodes there are in order to build
  ...
  const handleSelectChange = (e) => {
    ...
    //could call function here to get data from api
  }
  ...
  useEffect(
    ()=>{
      ...
      fetchEpisodeData()
    },[selectedOption] //runs any time this state changes
  )
